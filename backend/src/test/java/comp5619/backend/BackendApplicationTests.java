...
class BackendApplicationTests {
    ...
    private final LikedServiceTests likedServiceTests = new LikedServiceTests();
    ...
    @Test
    public void runAllLikedServicesTests() throws Exception{
        likedServiceTests.runAll(mockMvc);
    }
